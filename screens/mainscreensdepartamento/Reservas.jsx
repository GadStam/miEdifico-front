...
import { useFonts, Kanit_200ExtraLight } from "@expo-google-fonts/kanit";
...
const Reservas = ({ navigation, route }) => {
  ...
  const onCreateEvento = async (e) => {
    if (
      fechaSeleccionada.cant_invitados === null ||
      fechaSeleccionada.horas === null ||
      fechaSeleccionada.fecha === "" ||
      fechaSeleccionada.hora_inicio === "" ||
      fechaSeleccionada.nombre_evento === ""
    ) {
      ...
      await crearEvento({
        ...fechaSeleccionada,
        id_espaciocc: pileta ? 1 : terraza ? 2 : cochera ? 3 : null,
      })
        .then(() => {
        ...
        <View>
          <View style={styles.vista}>
            ...
            <Text style={styles.texto}>
              Seleccione que espacio comun desea reservar:
            </Text>
            ...
            <BotonFecha
              text={
                fechaSeleccionada.hora_inicio
                  ? `Día: ${fechaSeleccionada.fecha}, Hora: ${fechaSeleccionada.hora_inicio}`
                  : "Ingrese el día y la hora del evento"
              }
